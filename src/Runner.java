...
public class Runner {
	...
	public static void main(String[] args) {
		...
		looping = JOptionPane.showConfirmDialog(null, "Would you like to enter another number?", "Again?", JOptionPane.YES_NO_OPTION);
	...
	private int enterInteger() {
		int number = Integer.parseInt(JOptionPane.showInputDialog(null,"Please enter a number between 0-255."));
		return number;
	}
